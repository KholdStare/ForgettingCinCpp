...
% Overview of new featres of Classes
\begin{frame}
    \frametitle{\declarelesson Classes }
    \framesubtitle{C++ additions}
    \begin{itemize}
        \item C++ introduces classes, and ...
            \begin{itemize}
            ...
            \end{itemize}
        \item In C++ structs can also have all of the above
            \begin{itemize}
                \item Classes: \emph{members private} by default
                \item Structs: \emph{members public} by default
            \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        \item C++ introduces private members
            \begin{itemize}
                \item members only accessible inside its own methods
                \item All data accessible by any function
            \end{itemize}
        \item All data accessible by any function
    \end{itemize}
